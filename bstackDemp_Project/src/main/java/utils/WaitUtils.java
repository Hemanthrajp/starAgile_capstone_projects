...
public class WaitUtils {
	...
	public void implicitWait() {
		BaseFunction.driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
	}
	public static void VisibilityofElement(WebElement element) {
		WebDriverWait Wait = new WebDriverWait(BaseFunction.driver,Duration.ofSeconds(10));
